...
//    }
    ...
    public static int[] getXCoordinates(String line, int index) {
...
// left side
        ...
        int[] coordinatesX = new int[number.length()];

        for(int i = 0; i < left; i++) {
            coordinatesX[i] = index - left + i;
        }
        coordinatesX[0] = 2;
        coordinatesX[1] = 3;
        for(int i = left; i < index - 1 + right; i++) {
            coordinatesX[i] = right + i + 1;
        }
        return coordinatesX;
...
//    public static boolean calculateGear(String[] lines, int row, int col) {
//        int[] dx = {-1, -1, -1, 0, 0, 1, 1, 1};
//        int[] dy = {-1, 0, 1, -1, 1, -1, 0, 1};
//            for (int k = 0; k < 8; k++) {
//                int newRow = row + dx[k];
//                int newCol = col + dy[k];
//                if (isValidPosition(lines, newRow, newCol) && Character.isDigit(lines[newRow].charAt(newCol))) {
//                    int[] numCoordinates = getXCoordinates(lines[newRow], newCol);
//                    for(int i = 0; i < numCoordinates.length; i++) {
//                        if(numCoordinates[i] == )
//                    }
//
//                }
